...
NEWS_CACHE = {'updated_at': None, 'articles': []}
...
def get_admin_stats():
    ...
    cursor.close()
    conn.close()
    return jsonify({'status': 'success', 'stats': {'users': user_cnt, 'posts': post_cnt, 'comments': comment_cnt, 'stories': story_cnt}})
